...
export const Sandbox: Story = {
  ...
  render: args => html`
    <div class="flex flex-col gap-4 max-w-xl">
      ...
      >
        <h3 slot="summary" class="text-lg font-semibold px-3 py-2">What is Wikipedia?</h3>
        <div class="px-3 py-2">
          Wikipedia is an encyclopedia which is free to use and edit. It is available in many
          different languages and on many devices. The content of Wikipedia is free to reproduce
          under the Creative Commons Attribution-Sharealike 3.0 Unported License (CC-BY-SA) and the
      ...
      <zx-details
        class="bg-white rounded shadow hover:shadow-md custom"
        .disabled="${args.disabled}"
      >
        <h3 slot="summary" class="text-lg font-semibold px-3 py-3">Who writes Wikipedia?</h3>
