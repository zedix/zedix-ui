...
export class ZxRating extends LitElement {
  ...
  render() {
    ...
    if (this.shape === '1') {
      ...
      svg = `
      <svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 501.986 501.986" fill>
      ...
      svg = `
      <svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 43.128 43.128" fill>
      ...
      svg = `
      <svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 55.867 55.867" fill>
